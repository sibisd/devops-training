...
#   bucket                  = "ess-genaisandbox-${data.aws_caller_identity.current.account_id}-foundation-services-artifacts"
#   force_destroy           = false
#   logging                 = false
...
#   bucket                  = "ess-genaisandbox-${data.aws_caller_identity.current.account_id}-ragservice-artifacts"
#   force_destroy           = false
#   logging                 = false
#   restrict_public_buckets = true
#   versioning              = "Enabled"
...
#   bucket                  = "ess-genaisandbox-${data.aws_caller_identity.current.account_id}-chat-history-artifacts"
#   force_destroy           = false
#   logging                 = false
#   restrict_public_buckets = true
#   versioning              = "Enabled"
...
# resource "aws_iam_policy" "genai_services_lambda_execution_role_policy" {
...
#   policy      = data.aws_iam_policy_document.genai_services_lambda_execution_role_policy_document.json
# }
...
#   policy_arn = aws_iam_policy.genai_services_lambda_execution_role_policy.arn
#   depends_on = [
#     module.ess_genaisandbox_foundationservices_static_chat_pipeline_artifact
#   ]
# }
...
# # Attach the dynamic policy separately
# resource "aws_iam_role_policy_attachment" "ustsandbox_chat_history_sns_consumer_lambda_execution_role_policy_attachment" {
